...
const FAB: React.FC<FABProps> = ({ onAddTask, onAddNote, onAddBigNote }) => {
  ...
  const actions = [
    { label: 'Import from templates', icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"/></svg> },
