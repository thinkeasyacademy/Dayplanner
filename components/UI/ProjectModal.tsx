        ...
        <div className="p-6">
              ...
              <div className="flex justify-between">
                {colors.map(c => (
                  <button
                    key={c}
                    onClick={() => setColor(c)}
                    className={`w-10 h-10 rounded-full transition-all ${color === c ? 'ring-4 ring-offset-2 ring-blue-500 scale-110' : ''}`}
          ...
          <div className="flex gap-3 mt-8">
            ...
            <button 
              ...
              className="flex-1 py-3.5 bg-blue-600 text-white font-bold rounded-2xl shadow-lg shadow-blue-200 active:scale-95 transition-all"
            >
              Save
            </button>
          </div>
